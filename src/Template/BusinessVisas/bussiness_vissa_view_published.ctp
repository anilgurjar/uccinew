	  ...
	  <div class="col-sm-12 no-print">
				...
				<table class="table table-bordered" id="parant_table" style="width:100%;">
					...
					<tr>
						...
						<td><?= $this->Form->button(__('View') . $this->Html->tag('i', '', ['class'=>'fa fa-book']),['class'=>'btn btn-info btn-sm','formaction'=>'bussinessVissaPublishedView','formtarget'=>'_blank','value'=>$bussiness_vissa->id,'type'=>'Submit','name'=>'view']);   ?> </td>
						</tr>
