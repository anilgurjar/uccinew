<div class="col-md-12">
  ...
  <div class="box box-primary">
	<div class="box-header with-border">
	  <h3 class="box-title">Edit Business Visa</h3>
	</div>
	<!-- /.box-header -->
	<!-- form start -->
	...
	<div class="box-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
				...
				echo $this->Form->input('company_id', ['empty'=> '--Select--','data-placeholder'=>'Select a Company/Organisation','label' => false,'class'=>'form-control select2','options'=>$options,'style'=>'width:100%;','value'=>$company_id]); ?>
				</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<?php echo $this->Form->input('issue_date', ['label' => false,'placeholder'=>'Date of Issue','class'=>'form-control date-picker','data-date-format'=>'dd-mm-yyyy', 'type'=>'text','value'=>date('d-m-Y',strtotime($businessVisa->issue_date))]); ?>
			</div>
		</div>
		<div class="form-group">
		  ...
		  <div class="col-sm-4">	
			<?php echo $this->Form->input('expiry_date', ['label' => false,'placeholder'=>'Date of Expiry','class'=>'form-control date-picker','data-date-format'=>'dd-mm-yyyy', 'type'=>'text','value'=>date('d-m-Y',strtotime($businessVisa->expiry_date))]); ?>
		  </div>
		</div>
	</div>
	  <!-- /.box-body -->
