<div class="col-md-12">
  ...
  <div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">Visitor Country</label>
			<div class="col-sm-4">
				<?php echo $this->Form->input('visitor_country', ['label' => false,'placeholder'=>'Country of Visitor','class'=>'form-control']); ?>
			</div>
