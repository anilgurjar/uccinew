...
foreach($BusinessVisas as $BusinessVisa){
	//$amount=$BusinessVisa->total;
	$payment_amount=$BusinessVisa->payment_amount;
	$payment_tax_amount=$BusinessVisa->payment_tax_amount;
	$amount=$payment_amount+$payment_tax_amount;
	
	$exporter=$BusinessVisa->visitor_name;
}
?>
