	  ...
	  <div class="col-sm-12 no-print">
				...
				<table class="table table-bordered" id="parant_table" style="width:100%;">
					...
					<tr>
						...
						<td><?= $this->Form->button(__('Publish') . $this->Html->tag('i', '', ['class'=>'fa fa-book']),['class'=>'btn btn-success btn-sm','formaction'=>'draftView/'.$certificate_origin->id.'','formtarget'=>'_blank','type'=>'Submit','name'=>'view']);   ?> </td>
						</tr>
