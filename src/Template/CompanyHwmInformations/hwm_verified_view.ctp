<div class="col-md-12">
  <div class="box box-primary">
    <h3><?= __('Verified HWM Application') ?></h3>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel" style="text-align:left !important">Do you want to approve</h4>
							  </div>
							  ...
							  <div class="related_issue"></div>
								...
								<?php
									echo $this->Form->button($this->Html->tag('i', '', ['class'=>'fa fa-check-circle-o']) . __(' Approve') ,['class'=>'btn btn-success','type'=>'Submit','name'=>'hwm_approve_submit','value'=>$company->id]);
					...
					<div class="modal fade" id="notverify<?php echo $company->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  <div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title" id="myModalLabel" style="text-align:left">Do you want to reject </h4>
							  </div>
							  <div class="modal-body">
								<div class="row">
							  ...
							  <div class="related_issue"></div>
								<button type="button" class="btn btn-default cls" data-dismiss="modal">Close</button>
								<?php
									echo $this->Form->button($this->Html->tag('i', '', ['class'=>'fa fa-check-circle-o']) . __(' Reject') ,['class'=>'btn btn-danger','type'=>'Submit','name'=>'hwm_notapprove_submit','value'=>$company->id]);
								?>	 
							  </div>
							</div>
						  </div>
