<div class="col-md-12">
  <div class="box box-primary">
    <h3><?= __('Draft hwm Application') ?></h3>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel" style="text-align:left !important">Do you want to publish</h4>
							  </div>
							  ...
							  <div class="related_issue"></div>
								...
								<?php
									echo $this->Form->button($this->Html->tag('i', '', ['class'=>'fa fa-check-circle-o']) . __(' Publish') ,['class'=>'btn btn-success','type'=>'Submit','name'=>'hwm_approve_submit','value'=>$company->id]);
								?>	 
							  </div>
							</div>
						  </div>
