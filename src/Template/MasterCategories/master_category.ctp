...
<div class="col-md-12">
  ...
  <div class="box box-primary">
	...
	<!-- /.box-header -->
	<!-- form start -->
	<?= $this->Form->create($MasterCategories,['id'=>'purposeForm','class'=>'form-horizontal cmxform','method'=>'post']) ?>
	  <div class="box-body">
	  ...
	  <div class="box-footer">
	   <div class="col-sm-6">
		<center>
		<?= $this->Form->button($this->Html->tag('i', '', ['class'=>'fa fa-plus']) . __(' Submit'),['class'=>'btn btn-success','id'=>'master_category']); ?>
		</center>
		 </div>
	  </div>
	  <!-- /.box-footer -->
...
<div class="col-md-12">
  ...
  <div class="box box-primary">
	...
	<?php 
	$i=0;
	foreach($fetch_master_category as $data)
	{
	$i++;
	...
	<tr>
	<td><?php echo $i;?>
    <td><a href="#" class="editable_text" field_name="category_name" table_id="<?php echo $data->id; ?>"  data-type="text" data-pk="1"><?php echo $data->category_name; ?></a></td>
...
$(document).ready(function() { 
	...
	$("#purposeForm").validate({
		...
		submitHandler: function () {
				...
				$("#master_category").attr('disabled','disabled');
