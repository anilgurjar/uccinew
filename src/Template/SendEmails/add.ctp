...
<div class="col-md-12">
<?php echo $this->Form->create($sendEmail, ['type' => 'post','id'=>'registratiomForm','enctype' => 'multipart/form-data']); ?>
			...
			<div class="col-md-12 pad">
					 ...
					 <div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('subject', ['label' => false,'placeholder'=>'Subject','class'=>'form-control']); ?>
						</div>
					</div>
...
$("button:submit").click(function(){ alert();
