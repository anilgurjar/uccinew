<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Grievance Issue Related'), ['action' => 'edit', $grievanceIssueRelated->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Grievance Issue Related'), ['action' => 'delete', $grievanceIssueRelated->id], ['confirm' => __('Are you sure you want to delete # {0}?', $grievanceIssueRelated->id)]) ?> </li>
...
<div class="grievanceIssueRelateds view large-9 medium-8 columns content">
    <h3><?= h($grievanceIssueRelated->name) ?></h3>
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Grievance Issue') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($grievanceIssueRelated->industrial_grievances)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($grievanceIssueRelated->industrial_grievances as $industrialGrievances): ?>
            <tr>
