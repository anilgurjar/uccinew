		...
		<div class="col-sm-12 no-print">
			<div class="form-group col-sm-4">
			  ...
			  <?php 
				...
				echo $this->Form->input('member_id', ['empty'=> '--Select--','data-placeholder'=>'Select a Company/Organisation','label' => false,'class'=>'form-control select2','options'=>$options,'style'=>'width:100%;','value'=>$company_id,'disabled' ]); ?>
			...
			<?php
						...
						echo $this->Form->input('amount_type', array('templates' => ['radioWrapper' => '<div class="radio inline " style="margin-left: 8px !important;">{{label}}</div>'],'type' => 'radio','label' => false,'options' => $options,'hiddenField' => false)); ?>
			</div>
		...
		<div class="col-sm-12 no-print">
			<div class="form-group col-sm-4 display-data neft_data" style="line-height:1.3">
			  ...
			  <?php 
				...
				echo $this->Form->input('bank_id', ['empty'=> '--Select--','label' => false,'class'=>'form-control select2','options'=>$options,'style'=>'width:100%;']); ?>
			</div>
			...
			<div class="form-group col-sm-4">
			  ...
			  <?php echo $this->Form->input('due_amount', ['label' => false,'placeholder'=>'Due Amount','class'=>'form-control','type'=>'text','id'=>'due_amount','disabled','value'=>$due_amount]); ?>
