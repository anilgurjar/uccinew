			...
			<div class="col-md-12 pad">
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('member_name', ['label' => false,'placeholder'=>'Member Name','class'=>'form-control','value'=>$users[0]->member_name]); ?>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('email', ['label' => false,'placeholder'=>'Company E-mail','class'=>'form-control','value'=>$users[0]->email]); ?>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">Mobile No.</label>
							<?php echo $this->Form->input('mobile_no', ['label' => false,'placeholder'=>'Mobile Number','class'=>'form-control','value'=>$users[0]->mobile_no]); ?>
						</div>
					</div>
				</div>
				<div class="col-md-12 pad">
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('alternate_member', ['label' => false,'placeholder'=>'Alternate Nominee','class'=>'form-control second','value'=>@$users[1]->member_name]); ?>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<?php echo $this->Form->input('alternate_email', ['label' => false,'placeholder'=>'Company E-mail','class'=>'form-control second','value'=>@$users[1]->email]); ?>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">Alternate Mobile No.</label>
							<?php echo $this->Form->input('alternate_mobile', ['label' => false,'placeholder'=>'Mobile Number','class'=>'form-control second','value'=>@$users[1]->mobile_no]); ?>
						</div>
					</div>
				</div>
				<div class="col-md-12 pad">
