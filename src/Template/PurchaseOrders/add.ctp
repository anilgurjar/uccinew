...
<div class="col-md-12">
  ...
  <div class="box box-primary">
	<div class="box-header with-border no-print">
	  <h3 class="box-title">Purchase Order Add</h3>
	...
	<!-- form start -->
	  ...
	  <?= $this->Form->create($purchaseOrder,['id'=>'configform']) ?>
		...
		<div class="col-sm-12 no-print" style="margin-top:20px;" id="main">		
			...
			<td>
				<?php echo $this->Form->input('purchase_order_rows[0][quty]', ['label' => false,'placeholder'=>'Quantity','class'=>'form-control quantity calculate','id'=>'purchase_order_rows-0-quty','autocomplete'=>'off']); ?>
			</td>
			<td>
