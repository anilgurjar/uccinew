				...
				<div class="col-md-12 pad">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<?php echo $this->Form->input('valid_from', ['label' => false,'placeholder'=>'Valid From','class'=>'form-control date-picker','type'=>'text']); ?>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label">Valid To</label>
							<?php echo $this->Form->input('valid_to', ['label' => false,'placeholder'=>'Valid To','class'=>'form-control date-picker','type'=>'text']); ?>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
