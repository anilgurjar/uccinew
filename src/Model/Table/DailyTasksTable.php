 ...
 * @method \App\Model\Entity\DailyTask findOrCreate($search, callable $callback = null)
 */
class DailyTasksTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('task_completed', 'create')
            ->notEmpty('task_completed');

        $validator
            ->requirePresence('task_initiated', 'create')
            ->notEmpty('task_initiated');
