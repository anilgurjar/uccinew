...
use App\Model\Table\CoTaxAmountsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CoTaxAmountsTable Test Case
 */
class CoTaxAmountsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CoTaxAmountsTable
     */
    public $CoTaxAmounts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CoTaxAmounts') ? [] : ['className' => 'App\Model\Table\CoTaxAmountsTable'];
        $this->CoTaxAmounts = TableRegistry::get('CoTaxAmounts', $config);
    }
