...
use App\Model\Table\SendEmailAllsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SendEmailAllsTable Test Case
 */
class SendEmailAllsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SendEmailAllsTable
     */
    public $SendEmailAlls;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SendEmailAlls') ? [] : ['className' => 'App\Model\Table\SendEmailAllsTable'];
        $this->SendEmailAlls = TableRegistry::get('SendEmailAlls', $config);
    }
