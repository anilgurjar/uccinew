...
use App\Model\Table\EventHistoriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EventHistoriesTable Test Case
 */
class EventHistoriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EventHistoriesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EventHistories') ? [] : ['className' => 'App\Model\Table\EventHistoriesTable'];
        $this->EventHistories = TableRegistry::get('EventHistories', $config);
    }
