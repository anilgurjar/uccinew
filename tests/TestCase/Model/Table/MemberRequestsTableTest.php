...
use App\Model\Table\MemberRequestsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\MemberRequestsTable Test Case
 */
class MemberRequestsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\MemberRequestsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('MemberRequests') ? [] : ['className' => 'App\Model\Table\MemberRequestsTable'];
        $this->MemberRequests = TableRegistry::get('MemberRequests', $config);
    }
