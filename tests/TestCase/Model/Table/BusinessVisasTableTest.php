...
use App\Model\Table\BusinessVisasTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\BusinessVisasTable Test Case
 */
class BusinessVisasTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\BusinessVisasTable
     */
    public $BusinessVisas;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('BusinessVisas') ? [] : ['className' => 'App\Model\Table\BusinessVisasTable'];
        $this->BusinessVisas = TableRegistry::get('BusinessVisas', $config);
    }
