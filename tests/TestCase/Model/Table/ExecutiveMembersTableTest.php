...
use App\Model\Table\ExecutiveMembersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ExecutiveMembersTable Test Case
 */
class ExecutiveMembersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ExecutiveMembersTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ExecutiveMembers') ? [] : ['className' => 'App\Model\Table\ExecutiveMembersTable'];
        $this->ExecutiveMembers = TableRegistry::get('ExecutiveMembers', $config);
    }
