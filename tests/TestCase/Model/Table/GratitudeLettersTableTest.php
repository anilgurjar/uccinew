...
use App\Model\Table\GratitudeLettersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GratitudeLettersTable Test Case
 */
class GratitudeLettersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GratitudeLettersTable
     */
    public $GratitudeLetters;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('GratitudeLetters') ? [] : ['className' => 'App\Model\Table\GratitudeLettersTable'];
        $this->GratitudeLetters = TableRegistry::get('GratitudeLetters', $config);
    }
