...
use App\Model\Table\FacilityBookingsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FacilityBookingsTable Test Case
 */
class FacilityBookingsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\FacilityBookingsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FacilityBookings') ? [] : ['className' => 'App\Model\Table\FacilityBookingsTable'];
        $this->FacilityBookings = TableRegistry::get('FacilityBookings', $config);
    }
