...
use App\Model\Table\CooCouponsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CooCouponsTable Test Case
 */
class CooCouponsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CooCouponsTable
     */
    public $CooCoupons;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CooCoupons') ? [] : ['className' => 'App\Model\Table\CooCouponsTable'];
        $this->CooCoupons = TableRegistry::get('CooCoupons', $config);
    }
