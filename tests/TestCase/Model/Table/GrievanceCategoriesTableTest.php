...
use App\Model\Table\GrievanceCategoriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GrievanceCategoriesTable Test Case
 */
class GrievanceCategoriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GrievanceCategoriesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('GrievanceCategories') ? [] : ['className' => 'App\Model\Table\GrievanceCategoriesTable'];
        $this->GrievanceCategories = TableRegistry::get('GrievanceCategories', $config);
    }
    ...
    {
        unset($this->GrievanceCategories);
