...
use App\Model\Table\CompanyWasteInformationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CompanyWasteInformationsTable Test Case
 */
class CompanyWasteInformationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CompanyWasteInformationsTable
     */
    public $CompanyWasteInformations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CompanyWasteInformations') ? [] : ['className' => 'App\Model\Table\CompanyWasteInformationsTable'];
        $this->CompanyWasteInformations = TableRegistry::get('CompanyWasteInformations', $config);
    }
    ...
    {
        unset($this->CompanyWasteInformations);
