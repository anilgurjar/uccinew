...
use App\Model\Table\EmailShotsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EmailShotsTable Test Case
 */
class EmailShotsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EmailShotsTable
     */
    public $EmailShots;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EmailShots') ? [] : ['className' => 'App\Model\Table\EmailShotsTable'];
        $this->EmailShots = TableRegistry::get('EmailShots', $config);
    }
