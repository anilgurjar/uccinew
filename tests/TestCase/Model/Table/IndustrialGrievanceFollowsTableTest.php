...
use App\Model\Table\IndustrialGrievanceFollowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IndustrialGrievanceFollowsTable Test Case
 */
class IndustrialGrievanceFollowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IndustrialGrievanceFollowsTable
     */
    public $IndustrialGrievanceFollows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IndustrialGrievanceFollows') ? [] : ['className' => 'App\Model\Table\IndustrialGrievanceFollowsTable'];
        $this->IndustrialGrievanceFollows = TableRegistry::get('IndustrialGrievanceFollows', $config);
    }
    ...
    {
        unset($this->IndustrialGrievanceFollows);
