...
use App\Model\Table\ExecutiveCategoriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ExecutiveCategoriesTable Test Case
 */
class ExecutiveCategoriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ExecutiveCategoriesTable
     */
    public $ExecutiveCategories;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ExecutiveCategories') ? [] : ['className' => 'App\Model\Table\ExecutiveCategoriesTable'];
        $this->ExecutiveCategories = TableRegistry::get('ExecutiveCategories', $config);
    }
    ...
    {
        unset($this->ExecutiveCategories);
