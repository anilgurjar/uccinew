...
use App\Model\Table\MasterMemberTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\MasterMemberTypesTable Test Case
 */
class MasterMemberTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\MasterMemberTypesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('MasterMemberTypes') ? [] : ['className' => 'App\Model\Table\MasterMemberTypesTable'];
        $this->MasterMemberTypes = TableRegistry::get('MasterMemberTypes', $config);
    }
