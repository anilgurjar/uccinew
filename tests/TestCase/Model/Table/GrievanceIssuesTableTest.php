...
use App\Model\Table\GrievanceIssuesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\GrievanceIssuesTable Test Case
 */
class GrievanceIssuesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\GrievanceIssuesTable
     */
    public $GrievanceIssues;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('GrievanceIssues') ? [] : ['className' => 'App\Model\Table\GrievanceIssuesTable'];
        $this->GrievanceIssues = TableRegistry::get('GrievanceIssues', $config);
    }
