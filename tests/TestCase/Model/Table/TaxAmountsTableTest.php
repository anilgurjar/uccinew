...
use App\Model\Table\TaxAmountsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TaxAmountsTable Test Case
 */
class TaxAmountsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TaxAmountsTable
     */
    public $TaxAmounts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TaxAmounts') ? [] : ['className' => 'App\Model\Table\TaxAmountsTable'];
        $this->TaxAmounts = TableRegistry::get('TaxAmounts', $config);
    }
