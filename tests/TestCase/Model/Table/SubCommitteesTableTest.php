...
use App\Model\Table\SubCommitteesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SubCommitteesTable Test Case
 */
class SubCommitteesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SubCommitteesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SubCommittees') ? [] : ['className' => 'App\Model\Table\SubCommitteesTable'];
        $this->SubCommittees = TableRegistry::get('SubCommittees', $config);
    }
