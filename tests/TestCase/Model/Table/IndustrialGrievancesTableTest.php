...
use App\Model\Table\IndustrialGrievancesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IndustrialGrievancesTable Test Case
 */
class IndustrialGrievancesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IndustrialGrievancesTable
     */
    public $IndustrialGrievances;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IndustrialGrievances') ? [] : ['className' => 'App\Model\Table\IndustrialGrievancesTable'];
        $this->IndustrialGrievances = TableRegistry::get('IndustrialGrievances', $config);
    }
    ...
    {
        unset($this->IndustrialGrievances);
