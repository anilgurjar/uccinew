...
use App\Model\Table\CooEmailApprovalsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CooEmailApprovalsTable Test Case
 */
class CooEmailApprovalsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CooEmailApprovalsTable
     */
    public $CooEmailApprovals;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CooEmailApprovals') ? [] : ['className' => 'App\Model\Table\CooEmailApprovalsTable'];
        $this->CooEmailApprovals = TableRegistry::get('CooEmailApprovals', $config);
    }
