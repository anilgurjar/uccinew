...
use App\Model\Table\CompanyHwmInformationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CompanyHwmInformationsTable Test Case
 */
class CompanyHwmInformationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CompanyHwmInformationsTable
     */
    public $CompanyHwmInformations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CompanyHwmInformations') ? [] : ['className' => 'App\Model\Table\CompanyHwmInformationsTable'];
        $this->CompanyHwmInformations = TableRegistry::get('CompanyHwmInformations', $config);
    }
    ...
    {
        unset($this->CompanyHwmInformations);
